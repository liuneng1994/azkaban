...
public class JobRunner extends EventHandler implements Runnable {
    ...
    public JobRunner(ExecutableNode node, File workingDir, ExecutorLoader loader,
                     JobTypeManager jobtypeManager, JdbcDispExecutionParamsLoader dispExecutionParamsLoader,
    ...
    private Status prepareJob() throws RuntimeException {
        ...
        synchronized (syncObject) {
            ...
            // 添加扩展参数到props
            props.put("extra", org.apache.commons.lang.StringUtils.defaultIfEmpty(node.getExtra(),""));
            try {
